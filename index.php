                ...
                <div class="notices">
                    <ul >
                        <?php while ($notices->have_posts()) :
                            $notices->the_post(); ?>
                        <li>
                            <a href="<?php the_permalink(); ?>"><i class="icon-Asset-1"><span><?php the_title(); ?></span>
                             </a>
                        </li>
                        <?php endwhile; ?>
                    </ul>
        ...
        <div class="container">
            ...
            <div class="about-content section-gap">
                ...
                <p><?php echo get_theme_mod('welcomeparagraph1'); ?><br><br>
                    ...
                    <a href="<?php the_permalink(7);?>" class="btn"><?php echo get_theme_mod('about-button'); ?></a>
            </div>
        </div>
    </section>
            ...
            <div class="row ">
                <?php while ($news->have_posts()) : $news->the_post(); ?>
                    <div class="col-lg-4 col-md-8 news-container">
                        ...
                        <a href="<?php echo get_post_type_archive_link('news'); ?>" class="btn">Read More</a>
                        </div>
                    </div>
                <?php endwhile; ?>    
            </div>
